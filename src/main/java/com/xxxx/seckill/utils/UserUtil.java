...
import com.xxxx.seckill.config.RedisConfjg;
...
//            pstmt.setTimestamp(3, new Timestamp(user.getRegisterDate().getTime()));
        ...
        File file = new File("C:\\Users\\肖宇峰\\Desktop\\config.txt");
        if (file.exists()) {
            file.delete();
        }
    ...
    private static Connection getConn() throws Exception {
        String url = "jdbc:mysql://localhost:3306/webbase?useUnicode=true&characterEncoding=utf-8&useSSL=true";
...
//    }
    ...
    public static void main(String[] args) {
        System.out.println(redisTemplate.opsForValue().get("order:13000000000:1"));
    }
